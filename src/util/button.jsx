...
export default function Button({ extraStyle, disabled, text, handleSubmit }) {
  return (
    <p
      className="bg-gradient-to-br from-amber-100 via-teal-300 to-blue-200 px-4 p-2 rounded-2xl font-lg font-mono
